...
import org.gui4j.component.Gui4jSwitch;
...
public final class Gui4jSwitchFactory extends Gui4jJComponentFactory 
{
    private static final String NAME = "switch";
    private static final String PLACEMENT = "case";
    private static final String REFRESH = "refresh";
    private static final String ID = "id";
    private static final String CONDITION = "condition";
    private static final String DEFAULT = "default";

    private static final Log mLogger = LogFactory.getLog(Gui4jSwitchFactory.class);
        ...
        LElement e)
    {
        ...
        Gui4jSwitch gui4jSwitch = new Gui4jSwitch(gui4jComponentContainer, id, gui4jComponentDefault);
        ...
        for (Iterator it = children.iterator(); it.hasNext();)
        {
            try
            {
                ...
                Gui4jCall condition = getGui4jAccessInstance(Boolean.TYPE, gui4jSwitch, child, CONDITION);
                ...
                gui4jSwitch.addPlacement(condition, gui4jComponentInPath);
            }
            catch (Throwable t)
            {
                errorList.add(t);
        ...
        {
            Map m = null;
            Gui4jCall refresh = getGui4jAccessInstance(null, m, gui4jSwitch, e, REFRESH);
            if (refresh != null)
            {
                ...
                gui4jSwitch.setRefresh(dependantProperties);
            }
        }
    ...
    public void addToplevelAttributes(List attrList, Filter filter)
    {
        ...
        if (filter == null || filter.takeIt(Gui4jSwitchFactory.class))
        {
    ...
    public void addInnerAttributes(String elementName, List list)
    {
        if (PLACEMENT.equals(elementName))
        {
            Attribute[] attributesSubElement =
                {
                    new Attribute(ID, new AttributeTypeID(), REQUIRED, false),
